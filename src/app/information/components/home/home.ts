...
import {
  AwardAndCertificateMe,
  EducationMe,
  ExperinceMe,
  InterestMe,
  SkillMe,
} from '../../../sharedServiced/bean-shared';
...
@Component({
  selector: 'app-home',
  imports: [CommonModule, LoadingOverlay, ExperiencePopup],
...
export class Home implements OnInit, OnDestroy {
  ...
  getResumeData(): void {
    ...
    this.resumeData = this.service
      .getResumeDataForInformationHomePage()
      .subscribe({
        next: (data) => {
          this.isPageLoading = false;
          this.interestSection = { paragraphList: [] };
  ...
  openExperiencePopup(experince: ExperinceMe): void {
    this.selectedExperience = experince;
