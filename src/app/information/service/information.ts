...
export class Information {
  ...
  getDumpResumeData(): Observable<ResumeData> {
    ...
    var folio1: FolioInfo = { describtion: 'Discord Server คือโปรแกรมสื่อสารอย่างหนึ่ง <br> คลิกลิ้งค์ด้านล่างเพื่อเข้าสู่เซิฟเวอร์ได้เลย', imageUrl: 'https://firebasestorage.googleapis.com/v0/b/resume-9a2d0.appspot.com/o/image_icon%2FDiscord-screenshot.png?alt=media&token=1eb02005-9c70-41ce-b524-2fcc53951b71', linkto: { name: 'Click to Join Discord', url: 'https://discord.gg/VjDXWahQKX' } }
    ...
    var portfolio3: PortfolioMe = { id: 3, name: 'angular', detail: 'ระบบจองโต๊ะอาหาร Frontend', imageUrl: 'https://cdn.quokkalabs.com/blog/object/20240627123007_7a8d96795491496590cb510c21193b2c.webp', info: folio2 }
